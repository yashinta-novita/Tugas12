...
import com.example.aplikasikrs.Admin.Model.Matkul;
...
public class RecyclerViewDaftarMatkul extends AppCompatActivity {
    ...
    public void tambahData(){
        ...
        mkList.add(new Matkul("SI001","Pemrograman Mobile","Jumat","3","4"));
        mkList.add(new Matkul("SI002","Datawarehouse","Jumat","3","2"));
        mkList.add(new Matkul("SI003","IMK","Jumat","3","1"));
    }
}