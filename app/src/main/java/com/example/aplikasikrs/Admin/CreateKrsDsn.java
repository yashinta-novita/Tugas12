...
public class CreateKrsDsn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(CreateKrsDsn.this,android.R.layout.simple_spinner_item,dosen);
        ...
        btnSimpanKrs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CreateKrsDsn.this, AdminHome.class);
