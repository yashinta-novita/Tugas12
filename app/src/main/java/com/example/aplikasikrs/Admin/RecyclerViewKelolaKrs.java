...
public class RecyclerViewKelolaKrs extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId()==R.id.menu1){
            Intent intent = new Intent(RecyclerViewKelolaKrs.this, CreateKrsActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(RecyclerViewKelolaKrs.this);
